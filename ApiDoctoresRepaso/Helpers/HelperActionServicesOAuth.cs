...
namespace ApiCoreOAuthEmpleados.Helpers
{
    public class HelperActionServicesOAuth
    {
        ...
        //    Task.Run(async () =>
        //    {
        //        KeyVaultSecret secret = await this.secretClient.GetSecretAsync("Issuer");

        //        this.Issuer = secret.Value;
        //        secret = await this.secretClient.GetSecretAsync("Audience");

        //        this.Audience = secret.Value;
        //        secret = await this.secretClient.GetSecretAsync("SecretKey");
